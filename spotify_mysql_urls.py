...
sp = spotipy.Spotify(auth_manager=SpotifyClientCredentials(
    client_id='8e952524ce074b76ae3b6d0e95109792',  # Replace with your Client ID
    client_secret='ee437004b0a54820a117210e20e15b58'  # Replace with your Client Secret
))
...
db_config = {
    ...
    'password': 'lt.nj!53+I{DN$%pHk1=',   # Replace with your MySQL password
